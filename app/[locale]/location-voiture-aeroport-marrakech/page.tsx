      ...
      <main className="min-h-screen">
        <section className="bg-gradient-to-br from-orange-600 to-orange-800 text-white py-20 px-4">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-90">Livraison immédiate à l'arrivée · À partir de 150 MAD/jour · 7j/7</p>
            <Link href="/fr#reservation" className="bg-white text-orange-700 font-bold px-8 py-4 rounded-full text-lg hover:bg-yellow-100 transition-colors inline-block">Réserver maintenant</Link>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-left">
                <thead><tr className="bg-orange-600 text-white"><th className="px-4 py-3 rounded-tl-lg">Catégorie</th><th className="px-4 py-3">Modèle</th><th className="px-4 py-3">Prix / jour</th><th className="px-4 py-3 rounded-tr-lg">Inclus</th></tr></thead>
                <tbody>
                  {[
                    ...
                    { cat: 'Premium', model: 'VW Tiguan', price: '500 MAD', inc: 'Assurance tous risques, GPS' },
                  ].map((row, i) => (
              ...
              {faqs.map((faq) => (
                <details key={faq.question} className="bg-white rounded-xl p-6 shadow-sm group">
                  <summary className="font-semibold text-lg text-gray-800 cursor-pointer list-none flex justify-between items-center">
                    {faq.question}<span className="text-orange-600 text-xl group-open:rotate-45 transition-transform">+</span>
                  </summary>
